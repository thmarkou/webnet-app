...
export default function FindProfessionalsScreen() {
  ...
  const mockProfessionals = [
    ...
    },
    {
      ...
      distance: '4.1 km',
      availability: 'Διαθέσιμος',
      services: ['Συντήρηση', 'Επισκευή', 'Διαγνωστική'],
      description: 'Επαγγελματίας μηχανικός αυτοκινήτων με εξειδίκευση σε ευρωπαϊκά αυτοκίνητα. Γρήγορη και αξιόπιστη εξυπηρέτηση.',
      image: '🚗',
      verified: true,
      responseTime: '1.5 ώρες',
      completionRate: '99%',
      phone: '+30 210 4567890',
      email: 'petros.mixanikos@example.com'
    },
    {
      id: '13',
      ...
      distance: '2.8 km',
      availability: 'Διαθέσιμος',
      services: ['Άρθρα', 'Διαφημίσεις', 'Δημοσιογραφία'],
      description: 'Επαγγελματίας δημοσιογράφος με εμπειρία σε τοπικό τηλεοπτικό σταθμό. Εξειδικεύομαι σε οικονομικά και κοινωνικά θέματα.',
      image: '📺',
      verified: true,
      responseTime: '3 ώρες',
      completionRate: '95%',
      phone: '+30 210 5678901',
      email: 'eleni.dimosiografos@example.com'
    }
  ];
